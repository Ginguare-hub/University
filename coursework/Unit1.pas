...
Const
    ...
    TURRET_FIRE_RATE: Array [0..3] Of Double = (40.0, 40.0, 40.0, 40.0);

    BULLET_DAMAGE: Array [0..3] Of Double = (4.0, 4.0, 4.0, 4.0);
    BULLET_SLOW: Array [0..3] Of Double = (4.0, 4.0, 4.0, 4.0);
    ...
    BULLET_SPEED: Array [0..3] Of Double = (4.0, 4.0, 4.0, 4.0);
    ...
    Begin
        ...
        Begin
            ...
            Begin
                ...
                MapData[I, J].Turret.FireProgress := MapData[I, J].Turret.FireProgress + (MapData[I, J].Turret.FireRate * DeltaTime);

                If (MapData[I, J].Turret.FireProgress > 1) Then
                Begin
                    // Поиск врага
                    K := 0;
                    ...
                    If (IsToStop) Then
                    Begin
                        While (MapData[I, J].Turret.FireProgress > 1) Do   // Создаём пулю
                        Begin
                            MapData[I, J].Turret.FireProgress := MapData[I, J].Turret.FireProgress - 1;
...
Var
    I: Integer;
    ScreenX, ScreenY, TargetCellX, TargetCellY: Integer;
    Iterator: PTBulletNode;
    CurrBullet: PTBullet;
Begin
    Iterator := BulletList.Head;
    ...
    Begin
        ...
        ScreenX := Trunc(CELL_SIZE * (CurrBullet^.TurretCellX * (1 - CurrBullet^.DistanceProgress) + TargetCellX * (CurrBullet^.DistanceProgress)));
        ScreenY := MAP_HEIGHT * CELL_SIZE - Trunc(CELL_SIZE * (CurrBullet^.TurretCellY * (1 - CurrBullet^.DistanceProgress) + TargetCellY * (CurrBullet^.DistanceProgress))) - CELL_SIZE;
...
//        End;
        ...
        Canvas.Ellipse(ScreenX + 15, ScreenY + 15, ScreenX + CELL_SIZE - 15, ScreenY + CELL_SIZE - 15);
...
Begin
    ...
    Begin
        ...
        MapData[SelectedCellX, SelectedCellY].Turret.FireProgress := 0;
    End;
End;
