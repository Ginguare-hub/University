        ...
        Begin
            ...
            Begin
                ...
                Begin
                    ...
                    case MapData[I, J].TypeOfTurret Of
...
Begin
    ...
    Begin
        MapData[SelectedCellX, SelectedCellY].TypeOfTurret := TurrCommon;
...
begin
    If ((MapData[SelectedCellX, SelectedCellY].TypeOfGround = TGroundType.GtGrass) And MapData[SelectedCellX, SelectedCellY].IsAvailibleForTurret) Then
    Begin
        MapData[SelectedCellX, SelectedCellY].TypeOfTurret := TurrSlowing;
        MapData[SelectedCellX, SelectedCellY].IsAvailibleForTurret := False;
    End;
end;
...
begin
    If ((MapData[SelectedCellX, SelectedCellY].TypeOfGround = TGroundType.GtGrass) And MapData[SelectedCellX, SelectedCellY].IsAvailibleForTurret) Then
    Begin
        MapData[SelectedCellX, SelectedCellY].TypeOfTurret := TurrAreaDamaging;
        MapData[SelectedCellX, SelectedCellY].IsAvailibleForTurret := False;
    End;
end;
