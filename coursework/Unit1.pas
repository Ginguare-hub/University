...
Const
    ...
    IS_BULLET_AOE: Array [0..3] Of Boolean = (False, False, False, True);
...
Procedure Append(Var BulletList: TBulletList; Bullet: TBullet); Overload
Var
...
Procedure Delete(Var BulletList: TBulletList; BulletNode: PTBulletNode); Overload
Begin
...
Procedure Append(Var EnemySpawnsList: TEnemySpawnsList; EnemySpawns: TEnemySpawns); Overload
Var
...
Procedure Delete(Var EnemySpawnsList: TEnemySpawnsList; EnemySpawnsNode: PTEnemySpawnsNode); Overload
Begin
...
Begin
    ...
    Begin
        ...
        If (IsToStop) Then
        Begin
            While (CurrCell^.Turret.ReloadProgress > 1) Do
            Begin
...
Begin
    ...
    Begin
        ...
        Begin
            ...
            ScreenPos.CellX := Trunc((Enemies[I].Pos.CellX + (Enemies[I].DistanceProgress) * DeltaPos.CellX) * CELL_SIZE);
            ScreenPos.CellY := Trunc((MAP_HEIGHT - 1 - Enemies[I].Pos.CellY - (Enemies[I].DistanceProgress) * DeltaPos.CellY) * CELL_SIZE);
