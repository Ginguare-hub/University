...
Begin
    ...
    If (Not((CheckPos.CellX = Pos.CellX) And (CheckPos.CellY = Pos.CellY)) And (Map[CheckPos.CellX, CheckPos.CellY].TypeOfGround = GtRoad)) Then
    Begin
        IsEnd := False;
    End
    Else
            ...
            Begin
                ...
                Begin
                    ...
                    Begin
                        ...
                        Begin
                            DistanceSquared := CalculateDistanceSquared(I, J, Enemies[K].Pos.CellX, Enemies[K].Pos.CellY);
                    ...
                    Begin
                        ...
                        Begin
                            ...
                            Else
                            Begin
                                Bullet.TargetPos.CellX := Enemies[K].Pos.CellX;
                                Bullet.TargetPos.CellY := Enemies[K].Pos.CellY;
                            End;

                            Bullet.TurretPos.CellX := I;
                            Bullet.TurretPos.CellY := J;
                            //
