        ...
        while (isCycleAllowed) {
            ...
            while (isIncorrect) {
                ...
                try {
                    ...
                    isIncorrect = true;
                    System.out.println("Ошибка в записи числа a, повторите попытку.");
                }
 
                if (!isIncorrect && (a < MIN_NUM || a > MAX_NUM)) {
                    isIncorrect = true;
                    System.out.printf("Число a должно быть положительным и лежать в диапазоне [%d;%d], попробуйте ещё раз.", MIN_NUM, MAX_NUM);
                }
            }
            ...
            while (isIncorrect) {
                ...
                try {
                    ...
                    isIncorrect = true;
                    System.out.println("Ошибка в записи числа b, повторите попытку.");
                }
 
                if (!isIncorrect && (b < MIN_NUM || b > MAX_NUM)) {
                    isIncorrect = true;
                    System.out.printf("Число b должно быть положительным и лежать в диапазоне [%d;%d], попробуйте ещё раз.", MIN_NUM, MAX_NUM);
                }
            }
