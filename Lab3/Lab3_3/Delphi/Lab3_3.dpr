...
// Основная функция естественного слияния
Procedure NaturalMerge(Var Arr: TArray);
Var
    i, j: Integer;
    Sorted: Boolean;
    SeriesEnd: Integer;
Begin
    ...
    Repeat
        ...
        Begin
            ...
            j := i;
            While (j < High(Arr)) And (Arr[j] <= Arr[j + 1]) Do
                Inc(j);

            SeriesEnd := j;

            // Если достигли конца массива, выходим
            If SeriesEnd >= High(Arr) Then
                Break;
