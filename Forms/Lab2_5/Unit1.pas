...
Begin
    ...
    For I := Low(SArray) To High(SArray) Do
        If IsGood Then
            ...
            Except
                Application.MessageBox(PWideChar('Ошибка преобразования массива из строчного в целочисленный.'), 'Ошибка', MB_OK + MB_ICONERROR);
                IsGood := False;
            End;
...
Begin
    ...
    Begin
        ...
        StringGrid.Cells[I, 1] := '';                         //aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
    End;
End;
...
Var
    Error: ERROR_CODES;
    ArrLength, ArrHigh, I, CheckOnFullData: Integer;
