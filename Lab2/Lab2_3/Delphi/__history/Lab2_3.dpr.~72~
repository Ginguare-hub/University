...
Function CheckIsFileText(FileName: String): Boolean;

Var
    FileExt, TxtExt: String;
    IsText: Boolean;
    I, FirstIndex, LastIndex: Integer;

Begin

    FirstIndex := FileName.length - 4;
    FirstIndex := FileName.length - 1;
    TxtExt := '.txt';

    For I := FirstIndex To LastIndex Do
    Begin
        FileExt := FileExt + FileName[I];
    End;
